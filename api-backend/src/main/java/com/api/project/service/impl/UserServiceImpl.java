...
import static com.api.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public Boolean updateSecretKey(User user) {
        String secretKey = DigestUtil.md5Hex(SALT + UUID.randomUUID() + RandomUtil.randomNumbers(8));
        user.setSecretKey(secretKey);
